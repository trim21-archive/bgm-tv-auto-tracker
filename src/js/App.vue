<template>
  ...
  >
    ...
    >bgm.tv{{ score }} {{ episodeMarked?'✓':'' }}</div>
    <div class="bgm_tv_tracker_info">
      <div class="not_found" v-if="!subjectID">
        <label>
          <input class="subject" placeholder="条目ID或者对应条目链接" type="text" v-model="tmpSubjectID" />
      ...
      <br />
      <a :href="reportUrl" rel="noopener noreferrer" style="color: red" target="_blank">
        <p>报告问题</p>
      </a>
      <a
      ...
      <br />
      <input id="bgm_tv_tracker_auto_mark_watched" type="checkbox" v-model="config.autoMarkWatched" />
