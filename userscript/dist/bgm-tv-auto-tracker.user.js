...
class website_AbstractWebsite {
  constructor () {
    if (new.target === website_AbstractWebsite) {
...
class website_bilibili extends website_AbstractWebsite {
  static get name () {
...
class website_iQiyi extends website_AbstractWebsite {
  static get name () {
